                ...
                <div class="row">
                    <div class="col-12" data-aos="fade-up" data-aos-delay="100">
                        <div class="section-title process text-center pb-100">
                            ...
                            <h3 class="title">S'abonner à notre newsletter</h3>
                        ...
                        <div class="news-letter pb-100">
                            <form id="mc-form" action="#" class="news-letter-form position-relative">
                                ...
                                <button class="btn btn-warning">
                                    Souscrire <i class="icofont-rounded-double-right"></i>
                                </button>
                            </form>
                        </div>
                    </div>
                                    ...
                                    <div class="footer-widget">
                                        ...
                                        <ul class="adress">
                                            <li>
                                                ...
                                                <a href="tel:0123456789">ENV_NUM</a>
                                            </li>
                                            <li>
                                                <span class="icon"
                        ><i class="icofont-send-mail"></i
                      ></span>
                                                <a href="mailto:demo@gmail.com">ENV_EMAIL_COMPANY</a>
                                            </li>
                                            <li>
                                                <span class="icon"
                      ...
                      ></span>
                                        ...
                                        <ul class="footer-menu">
                                            <li>
                                                <a class="footer-link" href="#">
                                                    <i class="icofont-rounded-double-right"></i>Marketing Digital
                                                    </a>
                                            </li>
                                            <li>
                                                <a class="footer-link" href="#">
                                                    <i class="icofont-rounded-double-right"></i>Digitalisation de service
                                                    </a>
                                            </li>
                                            <!-- 
                                            <li>
                                                <a class="footer-link" href="#">
                                                    <i class="icofont-rounded-double-right"></i>Conception d'application mobile
                                                    </a>
                                            </li> -->

                                            <li>
                                                <a class="footer-link" href="#">
                                                    <i class="icofont-rounded-double-right"></i>Développement web & mobile
                                                    </a>
                                            </li>
                                            <li>
                                                <a class="footer-link" href="#">
                                                    <i class="icofont-rounded-double-right"></i>Formation & coaching
                                                    </a>
                                            </li>
                                            <li>
                                                <a class="footer-link" href="#">
                                                    <i class="icofont-rounded-double-right"></i>Reférencement SEO & SEA
                                                </a>
                                            </li>
                                            <li>
                                                <a class="footer-link" href="#">
                                                    <i class="icofont-rounded-double-right"></i> Copywriting & Rédaction web 
                                                    </a>
                                            </li>
                                            
                                            <li>
                                                <a class="footer-link" href="#">
                                                    <i class="icofont-rounded-double-right"></i>Gestion réseaux social
                                                    </a>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="footer-col">
                                    <div class="footer-widget">
                                        ...
                                        <p>
                                            Vous désiriez vous joindre à notre communauté ? Consultez nos réseaux sociaux.
                                        </p>
